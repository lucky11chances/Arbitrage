...
SPORTS_CATEGORIES: tuple[SportsCategory, ...] = (
    ...
    SportsCategory(
        ...
        arb_universe="ufc",
        arb_enabled=True,
        kalshi_series_ticker="KXUFCFIGHT",
        kalshi_candidate_series=("KXUFCFIGHT",),
        schedule_source="pm_ks_ufc_full_name_date_crosscheck",
        risk_level="paired",
        notes="Pairs UFC/MMA fight winners using Kalshi KXUFCFIGHT and PM UFC markets by date and fighter names; props/totals/method markets excluded.",
        sport_codes=("ufc",),
        adapter_name="ufc",
        arb_status="paired",
    ),
    ...
    SportsCategory(
        ...
        kalshi_candidate_series=("KXSOCCERGAME",),
        notes="Inventory first for non-World-Cup leagues; World Cup uses dedicated adapter, generic soccer pairing is pending league schedules.",
    ...
    SportsCategory(
        ...
        arb_universe="tennis",
        arb_enabled=True,
        kalshi_series_ticker="KXATPMATCH",
        kalshi_candidate_series=("KXATPMATCH", "KXATPCHALLENGERMATCH", "KXWTAMATCH", "KXITFMATCH", "KXITFWMATCH"),
        schedule_source="pm_ks_tennis_full_name_date_crosscheck",
        risk_level="paired",
        notes="Pairs ATP/WTA/ITF singles match winners by date, namespace, and full player-name outcomes. Set/spread/total/props are excluded.",
        sport_codes=("atp", "atp_challenger", "wta", "itf_men", "itf_women"),
        adapter_name="tennis",
        arb_status="paired",
    ),
    SportsCategory(
    ...
    SportsCategory(
        ...
        arb_universe="wnba",
        arb_enabled=True,
        kalshi_series_ticker="KXWNBAGAME",
        kalshi_candidate_series=("KXWNBAGAME", "KXWNBA", "KXNBAGAME", "KXNCAABGAME"),
        schedule_source="espn_wnba_scoreboard",
        risk_level="paired",
        notes="WNBA game pairing uses ESPN WNBA schedule and Kalshi KXWNBAGAME. NBA remains a separate category.",
        sport_codes=("wnba",),
    ...
    SportsCategory(
        ...
        notes="Inventory only for now; championship futures are excluded from normal sports-betting arb output.",
        sport_codes=("f1",),
        tag_ids=(435,),
        series=("11635",),
