...
KS_SERIES_TAXONOMY = {
    ...
    "KXUFCFIGHT": ("mma", "ufc", "fighter_winner", "unknown", "ks_series_ticker", "low"),
    "KXBOXING": ("boxing", "boxing", "fighter_winner", "unknown", "ks_series_ticker", "low"),
    "KXBOXINGGAME": ("boxing", "boxing", "fighter_winner", "unknown", "ks_series_ticker", "low"),
    ...
    "KXF1": ("motor_sports", "f1", "race_or_championship_winner", "open", "ks_series_ticker", "medium"),
}
...
PM_SOURCE_TAXONOMY = {
    ...
    "ufc": ("mma", "ufc", "unknown", "pm_source", "low"),
    "boxing": ("boxing", "boxing", "unknown", "pm_source", "low"),
...
GENERIC_PM_SOURCE_TAXONOMY = {
    ...
    "tag_id:435": ("motor_sports", "f1", "open"),
}
...
def infer_pm_market_type(category_key: str, universe: str, slug: str, title: str) -> str:
    ...
    if category_key == "esports" and MATCHUP_DELIMITER_RE.search(title):
        return "match_winner"
    if category_key in {"boxing", "mma"} and MATCHUP_DELIMITER_RE.search(title):
...
def entity_key(category_key: str, universe: str, competition_gender: str, value: str) -> str:
    ...
    if universe == "nba" and competition_gender == "men":
        team = index_nba_common.team_from_name(value)
